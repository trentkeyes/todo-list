...
const events = (() => {
  ...
  const inputTodo = () => {
    console.log(`Inputting ${_repos_todoRepo__WEBPACK_IMPORTED_MODULE_0__.todoRepo.currentTodo}`);
