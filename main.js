...
/* harmony import */ var _repos_todoRepo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../repos/todoRepo */ "./src/repos/todoRepo.js");
/* harmony import */ var _repos_projectRepo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../repos/projectRepo */ "./src/repos/projectRepo.js");
...
const render = (() => {
  ...
  const renderTodoItem = (todo) => {
    ...
    checkbox.addEventListener('click', _index__WEBPACK_IMPORTED_MODULE_0__.events.markComplete);
    listItem.addEventListener('click', _index__WEBPACK_IMPORTED_MODULE_0__.events.popupDetailsForm);
  ...
  const renderModifiedTodo = (id) => {
    const todo = _repos_todoRepo__WEBPACK_IMPORTED_MODULE_1__.todoRepo.todos[id];
  ...
  const renderTodoList = (e) => {
    ...
    const projectID = _repos_projectRepo__WEBPACK_IMPORTED_MODULE_2__.projectRepo.getProjectID(project);
    clearList();
    _repos_projectRepo__WEBPACK_IMPORTED_MODULE_2__.projectRepo.currentProject = projectID;
    const todoList = _repos_projectRepo__WEBPACK_IMPORTED_MODULE_2__.projectRepo.getProjectItems(projectID);
  ...
  const renderCompletedList = () => {
    const todoList = _repos_todoRepo__WEBPACK_IMPORTED_MODULE_1__.todoRepo.getCompletedTodos;
    _repos_projectRepo__WEBPACK_IMPORTED_MODULE_2__.projectRepo.currentProject = 'Completed';
    clearList();
    todoList.forEach((item) => {
      const listItem = document.createElement('li');
      const title = document.createElement('label');
  ...
  const renderSavedDetails = (id) => {
    ...
    project.value = _repos_projectRepo__WEBPACK_IMPORTED_MODULE_2__.projectRepo.projects[todo.projectID].title;
  };
...
/* harmony export */ });
/* harmony import */ var _repos_todoRepo__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./repos/todoRepo */ "./src/repos/todoRepo.js");
/* harmony import */ var _repos_projectRepo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./repos/projectRepo */ "./src/repos/projectRepo.js");
/* harmony import */ var _dom_render__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dom/render */ "./src/dom/render.js");
...
const events = (() => {
  ...
  const createInboxProject = () => {
    _repos_projectRepo__WEBPACK_IMPORTED_MODULE_1__.projectRepo.createProject('Inbox');
    _dom_render__WEBPACK_IMPORTED_MODULE_2__.render.renderProjectSelect('Inbox');
  };

  const inputTodo = () => {
    // modify if todo has already been created
    if (_repos_todoRepo__WEBPACK_IMPORTED_MODULE_0__.todoRepo.currentTodo !== null) {
      const id = _repos_todoRepo__WEBPACK_IMPORTED_MODULE_0__.todoRepo.currentTodo;
      updateTodoRecord(id);
      return;
    }
    // create a new todo
    const item = _repos_todoRepo__WEBPACK_IMPORTED_MODULE_0__.todoRepo.createTodo(
      taskName.value,
      description.value,
      dueDate.value,
      priority.value,
    ...
    if (item && _repos_projectRepo__WEBPACK_IMPORTED_MODULE_1__.projectRepo.currentProject === item.projectID) {
      _dom_render__WEBPACK_IMPORTED_MODULE_2__.render.renderTodoItem(item);
    }
    _dom_render__WEBPACK_IMPORTED_MODULE_2__.render.closeDetailsPopup();
  };

  const updateTodoRecord = (id) => {
    _repos_todoRepo__WEBPACK_IMPORTED_MODULE_0__.todoRepo.updateTodo(id, (record) => {
      ...
      record.setProjectID = _repos_projectRepo__WEBPACK_IMPORTED_MODULE_1__.projectRepo.getProjectID(project.value);
    });
    if (_repos_todoRepo__WEBPACK_IMPORTED_MODULE_0__.todoRepo.todos[id].projectID === _repos_projectRepo__WEBPACK_IMPORTED_MODULE_1__.projectRepo.currentProject) {
      _dom_render__WEBPACK_IMPORTED_MODULE_2__.render.renderModifiedTodo(id);
    }
    _repos_todoRepo__WEBPACK_IMPORTED_MODULE_0__.todoRepo.currentTodo = null;
    _dom_render__WEBPACK_IMPORTED_MODULE_2__.render.closeDetailsPopup();
  };

  const createProject = () => {
    const title = document.querySelector('#newProject');
    const project = _repos_projectRepo__WEBPACK_IMPORTED_MODULE_1__.projectRepo.createProject(title.value);
    if (project) {
      _dom_render__WEBPACK_IMPORTED_MODULE_2__.render.renderProjectTitle(project.title);
      _dom_render__WEBPACK_IMPORTED_MODULE_2__.render.renderProjectSelect(project.title);
    }
    title.value = '';
  };
  ...
  const markComplete = (e) => {
    ...
    _dom_render__WEBPACK_IMPORTED_MODULE_2__.render.renderRemovedItem(item);
    _repos_todoRepo__WEBPACK_IMPORTED_MODULE_0__.todoRepo.updateTodo(item.todoID, (record) => {
  ...
  const popupDetailsForm = (e) => {
    ...
    if (
      ...
      _dom_render__WEBPACK_IMPORTED_MODULE_2__.render.setCurrentListElement(e.target.parentElement);
      idToModify = e.target.parentElement.todoID;
    } else if (e.target.className === 'todoItem') {
      _dom_render__WEBPACK_IMPORTED_MODULE_2__.render.setCurrentListElement(e.target);
      idToModify = e.target.todoID;
    }
    _repos_todoRepo__WEBPACK_IMPORTED_MODULE_0__.todoRepo.currentTodo = idToModify;
    _dom_render__WEBPACK_IMPORTED_MODULE_2__.render.renderSavedDetails(idToModify);
  };
  ...
  inbox.addEventListener('click', _dom_render__WEBPACK_IMPORTED_MODULE_2__.render.renderTodoList);

  const completed = document.querySelector('#Completed');
  completed.addEventListener('click', _dom_render__WEBPACK_IMPORTED_MODULE_2__.render.renderCompletedList);

  const closeButton = document.querySelector('#closeButton');
  closeButton.addEventListener('click', _dom_render__WEBPACK_IMPORTED_MODULE_2__.render.closeDetailsPopup);
...
class TodoModel {
  ...
  get getDueDate() {
    ...
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(split[0], Number(split[1]) - 1, split[2]), 'PPPP');
  }
  set setID(newID) {
    this.id = newID;
  }
...
/* harmony import */ var _todoRepo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./todoRepo */ "./src/repos/todoRepo.js");
...
class ProjectRepo {
  ...
  getProjectItems(id) {
    const projectItems = _todoRepo__WEBPACK_IMPORTED_MODULE_1__.todoRepo.todos.filter(
...
/* harmony import */ var _src_repos_projectRepo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../src/repos/projectRepo */ "./src/repos/projectRepo.js");
...
class TodoRepo {
  ...
  createTodo(title, description, dueDate, priority, project) {
    if (title !== '') {
      ...
      const projectID = _src_repos_projectRepo__WEBPACK_IMPORTED_MODULE_1__.projectRepo.getProjectID(project);
