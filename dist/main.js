...
const events = (() => {
  ...
  const updateTodoRecord = (id) => {
    ...
    if (_src_index__WEBPACK_IMPORTED_MODULE_1__.todoRepo.todos[id].projectID === _src_index__WEBPACK_IMPORTED_MODULE_1__.projectRepo.currentProject) {
      ...
      _render__WEBPACK_IMPORTED_MODULE_0__.render.renderRemovedItem(_render__WEBPACK_IMPORTED_MODULE_0__.render.getCurrentListElement());
    }
...
const render = (() => {
  ...
  const fillItemDetails = (todo, title, description, dueDate, priority) => {
    ...
    if (todo.dueDate) {
      ...
      dueDate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  const renderProjectList = () => {
    const projectList = _src_index__WEBPACK_IMPORTED_MODULE_1__.projectRepo.projects;
...
_dom_render__WEBPACK_IMPORTED_MODULE_1__.render.renderProjectList();
_dom_render__WEBPACK_IMPORTED_MODULE_1__.render.renderProjectSelectors();
