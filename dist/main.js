...
const events = (() => {
  ...
  const updateTodoRecord = (id) => {
    _src_index__WEBPACK_IMPORTED_MODULE_1__.todoRepo.updateTodo(id, (record) => {
      ...
      record.setProjectID = _src_index__WEBPACK_IMPORTED_MODULE_1__.projectRepo.getProjectID(project.value);
    });
...
class ProjectRepo {
  ...
  createProject(title) {
    if (this.isValid(title)) {
      ...
      this.id++;
      _src_index__WEBPACK_IMPORTED_MODULE_1__.storage.projectsJSON.push(project.createJSON());
      console.log(this.projects);
      localStorage.setItem('projects', JSON.stringify(_src_index__WEBPACK_IMPORTED_MODULE_1__.storage.projectsJSON));
      return project;
    }
  }
  getProjectID(title) {
...
class TodoRepo {
  ...
  createTodo(title, description, dueDate, priority, project) {
    if (title !== '') {
      ...
      _src_index__WEBPACK_IMPORTED_MODULE_1__.storage.todosJSON.push(todo.createJSON());
      localStorage.setItem('todos', JSON.stringify(_src_index__WEBPACK_IMPORTED_MODULE_1__.storage.todosJSON));
      return todo;
    }
  }
  updateTodo(id, action) {
    ...
    action(record);
    // save to local storage
    _src_index__WEBPACK_IMPORTED_MODULE_1__.storage.todosJSON[id] = record;
    localStorage.setItem('todos', JSON.stringify(_src_index__WEBPACK_IMPORTED_MODULE_1__.storage.todosJSON));
  }
